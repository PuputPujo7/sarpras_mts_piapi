    ...
    <div class="h-screen flex">
        ...
        <div class="flex w-full lg:w-1/2 justify-center items-center bg-white space-y-8">
            <div class="w-full px-8 md:px-32 lg:px-24">
                ...
                <form wire:submit.prevent="login" class="bg-white rounded-md shadow-2xl p-5">
                    ...
                    <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                        ...
                        {{-- <input id="no_tiket" class=" pl-2 w-full outline-none border-none" type="number" name="no_tiket"
                            ...
                            <input id="email" class="form-control @error('email') is-invalid @enderror pl-2 w-full outline-none border-none" type="text" name="email"
                    ...
                    <div class="flex items-center border-2 mb-8 py-2 px-3 rounded-2xl">
                        ...
                        <input id="password" class="form-control @error('email') is-invalid @enderror pl-2 w-full outline-none border-none" type="text" name="password"
                            required />
                        @error('password')
                        <div class="invalid-feedback">
                            {{ $message }}
